...
void initState() {
  super.initState();
  controller.loadMessages();           // Load existing messages
  controller.subscribeToMessages();    // Listen for real-time updates
}

@override
void dispose() {
  controller.dispose();                  // Dispose chat controller
  messageController.dispose();           // Dispose text input controller
  ...
  controller.sendMessage(widget.username, messageController.text.trim()); // Send message
